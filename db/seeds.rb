...
m2 = Menu.create(:name => "tutorial", :title => "安装教程", :image => "/images/menu/tutorial-cover.jpg")
#m2.articles << a7 << a8
#m2.save


m3 = Menu.create(:name => "diagnostic", :title => "故障诊断", :image => '/images/menu/diagnostic-cover.jpg')
#m3.articles << a9 << a10 << a11
#m3.save

m4 = Menu.create(:name => "tools", :title => "工具及附件", :image => '/images/menu/tools-cover.jpg')
